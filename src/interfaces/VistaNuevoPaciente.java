...
public class VistaNuevoPaciente extends JFrame {
    ...
    VistaNuevoPaciente(TableModelPacientes tableModelPacientes){
        initComponents();
    ...
    public void initComponents(){
        ...
        JButton btnAgregarPaciente = new JButton("Sign Up");
        btnAgregarPaciente.setBackground(Color.CYAN);
        btnAgregarPaciente.setBounds(900,200,200,30);
        ...
        btnAgregarPaciente.addActionListener(e -> {
            ...
            if (digitoContador.isBlank() || txtNombres.getText().isBlank() || txtApellidos.getText().isBlank() || txtEdad.getText().isBlank()
                ...
                JOptionPane.showMessageDialog(this,"Su código de inicio de sesión es:"+digitoContador);
            }
        });
