...
public class VistaEditarPerfilDoctor extends JFrame {
    VistaEditarPerfilDoctor(Doctor doctor){
    ...
    public void initComponents(Doctor doctor){
        ...
        lblEspecialidad.setBounds(50,190,300,25);
        add(lblEspecialidad);

        JTextField txtEspecialidad = new JTextField();
        txtEspecialidad.setBounds(150,190,300,25);
        add(txtEspecialidad);

        JButton btnActualizarPerfilDoctor = new JButton("Actualizar");
        btnActualizarPerfilDoctor.setBackground(Color.CYAN);
        btnActualizarPerfilDoctor.setBounds(1000,300,100,50);
        add(btnActualizarPerfilDoctor);

        btnActualizarPerfilDoctor.addActionListener(e -> {
